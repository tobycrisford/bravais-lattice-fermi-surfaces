...
The energy of a free electron can take any positive value up to infinity. For each possible value of the momentum, there is a corresponding energy of the electron, and as the momentum varies across the full range of the infinite momentum space it lives in, the energy of the electron takes every positive value. The energy of a lattice electron also varies continuously, with *crystal* momentum. For each value of the crystal momentum, there will be a corresponding energy value for the electron. But the crystal momentum does not live in an infinite space. It lives only in the first Brillouin zone, which is finite. As it varies across this zone, it only hits a finite *band* of energy values.
